...
export const BRAZIL_TEAMS: Team[] = [
    ...
    { id: 'AGO', name: 'Atlético-GO', aliases: ['Atlético-GO', 'Atlético Goianiense', 'AGO', 'Dragão', 'Rubro-Negro Goiano'] },
    { id: 'CEA', name: 'Ceará', aliases: ['Ceará', 'Ceará Sporting Club', 'CEA', 'Vozão', 'Alvinegro'] },
    { id: 'CUI', name: 'Cuiabá', aliases: ['Cuiabá', 'Cuiabá Esporte Clube', 'CUI', 'Dourado', 'Auriverde'] },
